...
Similar to application.py bu used for build_db.py
'''
import os, sys
...
class ParameterForm(FlaskForm):
    ...
    promoter_peak_count = IntegerField('Enhancer Peak Count', validators=[NumberRange(0, 100000, message="Must be an integer in range [0,100000]")])
    enhancer_peak_count = IntegerField('Enhancer Peak Count', validators=[NumberRange(0, 100000, message="Must be an integer in range [0,100000]")])
...
def promoter_form():
    ...
    if form.validate_on_submit():
        ...
        query_data_dict = {                         # Input data for the pipeline
            ...
            "promoter_peak_count": form.promoter_peak_count.data,
            "enhancer_peak_count": form.enhancer_peak_count.data,
